    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (drawer != null) {
            ...
            if (mAuth != null) {
                ...
                mUserDatabase = myuserfirebasedatabase.getReference().child("Users").child("Drivers").child(userID);
        ...
        if (saveinformationhere != null) {
            ...
            if (movetonext != null) {
                movetonext.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(ClientSecurityCheck.this, ClientVerificationPage.class);
                        if (intent != null) {
            ...
            if (!TextUtils.isEmpty(thegpscodeinformationstring)  && mImageUri != null) {
                ...
                filepath.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        mUserDatabase.setValue(userstobesent, new
                                DatabaseReference.CompletionListener() {
                                    @Override
                                    public void onComplete(DatabaseError databaseError, DatabaseReference
                                            databaseReference) {
                                        Toast.makeText(getApplicationContext(), "Security Information Added", Toast.LENGTH_SHORT).show();
                                        Intent addadminproductactivity = new Intent(ClientSecurityCheck.this, ClientSecurityCheck.class);
                        ...
                        mUserDatabase.setValue(userstobesent, new
                                DatabaseReference.CompletionListener() {
                                    ...
                                    public void onComplete(DatabaseError databaseError, DatabaseReference
                                        ...
                                        Intent clientsecuritycheckintent = new Intent(ClientSecurityCheck.this, ClientSecurityCheck.class);

                                        startActivity(clientsecuritycheckintent);
        ...
        if (id == R.id.viewallcustomershere) {
                ...
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        Intent intent = new Intent(ClientSecurityCheck.this, ResidentialInfo.class);
                        if (intent != null) {
                            intent.putExtra("userID", userID);
                            intent.putExtra("role", role);
                            startActivity(intent);
