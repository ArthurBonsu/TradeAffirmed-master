...
public  class  AllGoodsBought extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OrderRef = myfirebaseDatabase.getReference().child("Order");
        ...
        if (mGoogleApiClient != null) {
            mGoogleApiClient = new GoogleApiClient.Builder(this).enableAutoManage(AllGoodsBought.this,
    ...
    public void fetch() {
        ...
        if (mAuth != null) {
            ...
            if (user != null) {
                traderID = user.getUid();
                OrderRef = FirebaseDatabase.getInstance().getReference().child("Order").child("products");
                OrderRef.keepSynced(true);
                orderkey = OrderRef.getKey();

                 tradergoodsbought = traderID + "true";
                if (traderID != null) {
                    if (OrderRef != null) {
                        Query OrderQuery = OrderRef.orderByChild("traderandpaid").equalTo(tradergoodsbought);
                        //    Query OrderQuery = ProductsRef;
                        ...
                        if (OrderQuery != null) {
                            ...
                            FirebaseRecyclerOptions<Products> options =
                                    new FirebaseRecyclerOptions.Builder<Products>()
                                            .setQuery(OrderQuery, new SnapshotParser<Products>() {
                                ...
                                protected void onBindViewHolder(final ViewHolder holder, final int position, final Products model) {
                                    ...
                                    holder.maintainproduct.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            if (role.equals("Trader")) {
                                                Intent intent = new Intent(AllGoodsBought.this, AdminMaintainProductsActivity.class);
                                                if (intent != null) {
                                    ...
                                    holder.product_imagehere.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            if (role.equals("Trader")) {
                                                Intent intent = new Intent(AllGoodsBought.this, AdminProductDetails.class);
                                                if (intent != null) {
                                    ...
                                    holder.thetraderimageforproduct.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            if (role.equals("Trader")) {
                                                Intent intent = new Intent(AllGoodsBought.this, TraderProfile.class);
                                                intent.putExtra("pid", pid);
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        Intent intent = new Intent(AllGoodsBought.this, AdminAllCustomers.class);
                        if (intent != null) {
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        cusomerId = user.getUid();
                        Intent intent = new Intent(AllGoodsBought.this, AdminAddNewProductActivityII.class);
                        if (intent != null) {
                            intent.putExtra("traderorcustomer", traderID);
                            intent.putExtra("role", role);
                            startActivity(intent);
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        cusomerId = user.getUid();
                        Intent intent = new Intent(AllGoodsBought.this, ViewYourPersonalProduct.class);
                        if (intent != null) {
                            intent.putExtra("traderorcustomer", traderID);
                            intent.putExtra("role", role);
                            startActivity(intent);
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        cusomerId = user.getUid();
                        Intent intent = new Intent(AllGoodsBought.this, ViewSpecificUsersCart.class);
                        if (intent != null) {
                            intent.putExtra("traderorcustomer", traderID);
                            intent.putExtra("role", role);
                            startActivity(intent);
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        cusomerId = user.getUid();
                        Intent intent = new Intent(AllGoodsBought.this, ViewAllCarts.class);
                        if (intent != null) {
                            intent.putExtra("traderorcustomer", traderID);
                            intent.putExtra("role", role);
                            startActivity(intent);
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        cusomerId = user.getUid();
                        Intent intent = new Intent(AllGoodsBought.this, AdminCategoryActivity.class);
                        if (intent != null) {
                            intent.putExtra("traderorcustomer", traderID);
                            intent.putExtra("role", role);
                            startActivity(intent);
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        cusomerId = user.getUid();
                        Intent intent = new Intent(AllGoodsBought.this, AdminAllProducts.class);
                        if (intent != null) {
                            intent.putExtra("traderorcustomer", traderID);
                            intent.putExtra("role", role);
                            startActivity(intent);
    ...
    public boolean onNavigationItemSelected (MenuItem item)
    {
        ...
        if (id == R.id.viewmap) {
            if (!role.equals("Trader")) {
                ...
                Intent intent = new Intent(AllGoodsBought.this, com.simcoder.bimbo.CustomerMapActivity.class);
                if (intent != null) {
                ...
                Intent intent = new Intent(AllGoodsBought.this, DriverMapActivity.class);
                if (intent != null) {
        ...
        if (id == R.id.nav_cart) {
            if (!role.equals("Trader")) {
                Intent intent = new Intent(AllGoodsBought.this, CartActivity.class);
                if (intent != null) {
                    startActivity(intent);
                }
            }
        ...
        if (id == R.id.viewproducts) {
            if (!role.equals("Trader")) {
                Intent intent = new Intent(AllGoodsBought.this, HomeActivity.class);
                if (intent != null) {
                    startActivity(intent);
                }
            } else {
        ...
        if (id == R.id.nav_search) {
            if (!role.equals("Trader")) {
                Intent intent = new Intent(AllGoodsBought.this, SearchProductsActivity.class);
                if (intent != null) {
                    startActivity(intent);
                }
            } else {
        ...
        if (id == R.id.nav_logout) {
            ...
            if (FirebaseAuth.getInstance() != null) {
                ...
                if (mGoogleApiClient != null) {
                    mGoogleSignInClient.signOut().addOnCompleteListener(AllGoodsBought.this,
            ...
            Intent intent = new Intent(AllGoodsBought.this, com.simcoder.bimbo.MainActivity.class);
            if (intent != null) {
                startActivity(intent);
                finish();
            }
        ...
        if (id == R.id.nav_settings) {
            if (!role.equals("Trader")) {
                Intent intent = new Intent(AllGoodsBought.this, com.simcoder.bimbo.WorkActivities.SettinsActivity.class);
                if (intent != null) {
                    startActivity(intent);
                }
            } else {
        ...
        if (id == R.id.nav_history) {
            if (!role.equals("Trader")) {
                Intent intent = new Intent(AllGoodsBought.this, HistoryActivity.class);
                if (intent != null) {
                    startActivity(intent);
                }
            } else {
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        cusomerId = user.getUid();
                        Intent intent = new Intent(AllGoodsBought.this, CustomerProfile.class);
                        if (intent != null) {
                            intent.putExtra("traderorcustomer", traderID);
                            intent.putExtra("role", role);
                            startActivity(intent);
