...
public class ResidentialInfoSubmitModelForClient {

    String address , gpscode, street,residenceinfoapprovestatus;

    public ResidentialInfoSubmitModelForClient(String gpscode, String  street, String residenceinfoapprovestatus) {
    }


    public ResidentialInfoSubmitModelForClient(
