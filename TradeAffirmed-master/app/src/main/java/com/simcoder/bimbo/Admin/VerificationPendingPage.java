        ...
        if (saveinformationhere != null) {
            ...
            if (movetonext != null) {
                movetonext.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(VerificationPendingPage.this, VerificationPendingPage.class);
                        if (intent != null) {
                        ...
                        mAdminTraderDatabase.setValue(userstobesent, new
                                DatabaseReference.CompletionListener() {
                                    ...
                                    public void onComplete(DatabaseError databaseError, DatabaseReference
                                        ...
                                        Intent addadminproductactivity = new Intent(VerificationPendingPage.this, SecurityCheck2.class);
