...
public class SecurityInfoSubmitModelForClient {

    String gpscode , gpsimage, securityinfoapprovestatus, securityapprovalapprove, status, approvalID, uid, tid, natidimage;



    public SecurityInfoSubmitModelForClient(
           String  uid, String gpscode,String  gpsimage,String natidimage, String approvalID, String securityinfoapprovestatus
    ) {
        this.uid =uid;
