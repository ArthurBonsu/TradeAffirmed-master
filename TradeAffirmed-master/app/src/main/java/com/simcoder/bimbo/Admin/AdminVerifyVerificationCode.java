...
public class AdminVerifyVerificationCode extends AppCompatActivity {
    String role;
    ...
    public AdminVerifyVerificationCode() {
        super();
    }
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adminverificationcodesverify);
            ...
            public void onClick(View v) {
                PhoneAuthProvider.getInstance().verifyPhoneNumber("+233" + getIntent().getStringExtra("mobile"), 60, TimeUnit.SECONDS,AdminVerifyVerificationCode.this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationFailed(@NonNull FirebaseException e) {
                        ...
                        Toast.makeText(AdminVerifyVerificationCode.this, "e.getMessage", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onCodeSent(@NonNull String newverificationId, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                        verificationId = newverificationId;
                        Toast.makeText(AdminVerifyVerificationCode.this, "Code Resent", Toast.LENGTH_SHORT).show();
