...
public class ApprovalSignup extends AppCompatActivity
{
    private Button CreateAccountButton;
    private EditText InputName, InputPhoneNumber, InputPassword, InputEmail;
    private ProgressDialog loadingBar;
    DatabaseReference ApproverDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.approvalsignup);
        ...
        if (userintent.getExtras().getString("userID") != null) {
            approverID = userintent.getExtras().getString("userID");
        }
        ...
        if (mGoogleApiClient != null) {
            mGoogleApiClient = new GoogleApiClient.Builder(this).enableAutoManage(ApprovalSignup.this,
        ...
        if (acct != null) {
            ...
            if (mAuth !=null) {
                mAuth.signInWithCredential(credential)
                        .addOnCompleteListener(ApprovalSignup.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (user != null) {
                                        ...
                                        ApproverDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("Approvers");


                                        usertraderskey = ApproverDatabase.push().getKey();
                                        ...
                                        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                if (!dataSnapshot.child("Approvers").child(approverID).exists()) {
                                                            ...
                                                            firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
                                                                ...
                                                                public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                                                                    ...
                                                                    if (user != null) {
                                                                        ...
                                                                        approverID = user.getUid();
                                                                        role = "Approver";
                                                                        ApproverDatabase.child(approverID).setValue("role", role);

                                                                        if (FirebaseDatabase.getInstance().getReference().child("Users").child("Approvers").child(approverID) != null && role.equals("Approver")) {


                                                                            Toast.makeText(ApprovalSignup.this, "logged in Successfully...", Toast.LENGTH_SHORT).show();
                                                                            loadingBar.dismiss();
                                                                            Intent intent = new Intent(ApprovalSignup.this, AdminCategoryActivity.class);
                                                                        ...
                                                                        loadingBar.dismiss();
                                                                        Toast.makeText(ApprovalSignup.this, "Approver " + acct.getDisplayName() + "already exists", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    Toast.makeText(ApprovalSignup.this, "sign in error", Toast.LENGTH_SHORT).show();
                                                }
                                ...
                                firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
                                    ...
                                    public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                                        ...
                                        if (user != null) {
                                            ...
                                            RootRef.child("Users").child("Approvers").child(approverID).updateChildren(userdataMap)
                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        @Override
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            if (task.isSuccessful()) {
                                                                Toast.makeText(ApprovalSignup.this, "Congratulations, your account has been created.", Toast.LENGTH_SHORT).show();
                                                                loadingBar.dismiss();

                                                                Intent intent = new Intent(ApprovalSignup.this, ApprovalLogin.class);
                                                                startActivity(intent);
                                                            } else {
                                                                loadingBar.dismiss();
                                                                Toast.makeText(ApprovalSignup.this, "Network Error: Please try again after some time...", Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                                    });
                                        } else {
                                            Toast.makeText(ApprovalSignup.this, "This " + user.getDisplayName() + " already exists.", Toast.LENGTH_SHORT).show();
                                            loadingBar.dismiss();
                                            Toast.makeText(ApprovalSignup.this, "Please try again using another email", Toast.LENGTH_SHORT).show();

                                            Intent intent = new Intent(ApprovalSignup.this, ApprovalSignup.class);
                                            startActivity(intent);
                                        }
                                    }
                                };
