...
public  class  AdminUserOrderDetails extends AppCompatActivity
   ...
   String  userkey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mGoogleApiClient != null) {
            mGoogleApiClient = new GoogleApiClient.Builder(this).enableAutoManage(AdminUserOrderDetails.this,
            ...
            if (user != null) {
                ...
                if (traderID != null) {
                    if (OrdersReference != null) {
                        Query OrdersQuery = OrdersReference.orderByChild("tid").equalTo(traderID);
                        ...
                        if (OrdersQuery != null) {
                            ...
                            FirebaseRecyclerOptions<AdminOrders> options =
                                    new FirebaseRecyclerOptions.Builder<AdminOrders>()
                                            .setQuery(OrdersQuery, new SnapshotParser<AdminOrders>() {


                                                @NonNull
                                                @Override
                                                public AdminOrders parseSnapshot(@NonNull DataSnapshot snapshot) {
                            ...
                            adapter = new FirebaseRecyclerAdapter<AdminOrders, ViewHolder>(options) {
                                @Override
                                ...
                                protected void onBindViewHolder(@NonNull ViewHolder holder, int i, @NonNull AdminOrders model) {
                                    if (model != null) {
                                        ...
                                        holders.product_name.setText(pname);
                                        holders.thetraderiknow.setText(tradername);
                                        holders.product_description.setText(desc);
                                        holders.product_price.setText("Price = " + "$" + price);                                  //   thetraderimageforproduct
                                        ...
                                        holders.setTraderImage(getApplication(), traderimage);
                                        holders.setImage(getApplicationContext(), pimage);
                                        ...
                                        firebasequery.addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                ...
                                                if (dataSnapshot.child("pname").getValue() != null) {
                                                    theproductname = dataSnapshot.child("pname").getValue(String.class);
                                                    holders.product_name.setText(theproductname);
                                                    Log.d(TAG, "The Product Name " + theproductname);
                                                }

                                                if (dataSnapshot.child("desc").getValue() != null) {
                                                    thedesc = dataSnapshot.child("desc").getValue(String.class);
                                                    holders.product_description.setText(thedesc);
                                                    Log.d(TAG, "The Product Desc " + thedesc);
                                                }

                                                if (dataSnapshot.child("pname").getValue() != null) {
                                                    image = dataSnapshot.child("pname").getValue(String.class);
                                                    holders.product_description.setText(pname);
                                                    ...
                                                    Log.d(TAG, "The customer image " + pimage);
                                                }

                                                if (dataSnapshot.child("price").getValue() != null) {
                                                    theprice = dataSnapshot.child("price").getValue(String.class);
                                                    holders.product_price.setText(theprice);
                                                    Log.d(TAG, "The user price " + theprice);
                                                }
                                    ...
                                    holders.maintainproduct.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View v) {
                                            if (role.equals("Trader")) {
                                                Intent intent = new Intent(AdminUserOrderDetails.this, AdminMaintainProductsActivity.class);
                                                if (intent != null) {
                                    ...
                                    holders.product_imagehere.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View view) {
                                            if (role.equals("Trader")) {
                                                Intent intent = new Intent(AdminUserOrderDetails.this, AdminProductDetails.class);
                                                if (intent != null) {
                                    ...
                                    holders.thetraderimageforproduct.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View view) {
                                            if (role.equals("Trader")) {
                                                Intent intent = new Intent(AdminUserOrderDetails.this, TraderProfile.class);
                                                intent.putExtra("pid", pid);
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        Intent intent = new Intent(AdminUserOrderDetails.this, AdminAllCustomers.class);
                        if (intent != null) {
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        cusomerId = user.getUid();
                        Intent intent = new Intent(AdminUserOrderDetails.this, AdminAddNewProductActivityII.class);
                        if (intent != null) {
                            intent.putExtra("traderorcustomer", traderID);
                            intent.putExtra("role", role);
                            startActivity(intent);
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        cusomerId = user.getUid();
                        Intent intent = new Intent(AdminUserOrderDetails.this, ViewYourPersonalProduct.class);
                        if (intent != null) {
                            intent.putExtra("traderorcustomer", traderID);
                            intent.putExtra("role", role);
                            startActivity(intent);
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        cusomerId = user.getUid();
                        Intent intent = new Intent(AdminUserOrderDetails.this, ViewSpecificUsersCart.class);
                        if (intent != null) {
                            intent.putExtra("traderorcustomer", traderID);
                            intent.putExtra("role", role);
                            startActivity(intent);
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        cusomerId = user.getUid();
                        Intent intent = new Intent(AdminUserOrderDetails.this, ViewAllCarts.class);
                        if (intent != null) {
                            intent.putExtra("traderorcustomer", traderID);
                            intent.putExtra("role", role);
                            startActivity(intent);
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        cusomerId = user.getUid();
                        Intent intent = new Intent(AdminUserOrderDetails.this, AdminCategoryActivity.class);
                        if (intent != null) {
                            intent.putExtra("traderorcustomer", traderID);
                            intent.putExtra("role", role);
                            startActivity(intent);
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        cusomerId = user.getUid();
                        Intent intent = new Intent(AdminUserOrderDetails.this, AdminAllProducts.class);
                        if (intent != null) {
                            intent.putExtra("traderorcustomer", traderID);
                            intent.putExtra("role", role);
                            startActivity(intent);
    ...
    public boolean onNavigationItemSelected (MenuItem item)
    {
        ...
        if (id == R.id.viewmap) {
            if (!role.equals("Trader")) {
                ...
                Intent intent = new Intent(AdminUserOrderDetails.this, com.simcoder.bimbo.CustomerMapActivity.class);
                if (intent != null) {
                ...
                Intent intent = new Intent(AdminUserOrderDetails.this, DriverMapActivity.class);
                if (intent != null) {
        ...
        if (id == R.id.nav_cart) {
            if (!role.equals("Trader")) {
                Intent intent = new Intent(AdminUserOrderDetails.this, CartActivity.class);
                if (intent != null) {
                    startActivity(intent);
                }
            }
        ...
        if (id == R.id.viewproducts) {
            if (!role.equals("Trader")) {
                Intent intent = new Intent(AdminUserOrderDetails.this, HomeActivity.class);
                if (intent != null) {
                    startActivity(intent);
                }
            } else {
        ...
        if (id == R.id.nav_search) {
            if (!role.equals("Trader")) {
                Intent intent = new Intent(AdminUserOrderDetails.this, SearchProductsActivity.class);
                if (intent != null) {
                    startActivity(intent);
                }
            } else {
        ...
        if (id == R.id.nav_logout) {
            ...
            if (FirebaseAuth.getInstance() != null) {
                ...
                if (mGoogleApiClient != null) {
                    mGoogleSignInClient.signOut().addOnCompleteListener(AdminUserOrderDetails.this,
            ...
            Intent intent = new Intent(AdminUserOrderDetails.this, com.simcoder.bimbo.MainActivity.class);
            if (intent != null) {
                startActivity(intent);
                finish();
            }
        ...
        if (id == R.id.nav_settings) {
            if (!role.equals("Trader")) {
                Intent intent = new Intent(AdminUserOrderDetails.this, com.simcoder.bimbo.WorkActivities.SettinsActivity.class);
                if (intent != null) {
                    startActivity(intent);
                }
            } else {
        ...
        if (id == R.id.nav_history) {
            if (!role.equals("Trader")) {
                Intent intent = new Intent(AdminUserOrderDetails.this, HistoryActivity.class);
                if (intent != null) {
                    startActivity(intent);
                }
            } else {
            ...
            if (!role.equals("Trader")) {
                if (FirebaseAuth.getInstance() != null) {
                    ...
                    if (user != null) {
                        ...
                        cusomerId = user.getUid();
                        Intent intent = new Intent(AdminUserOrderDetails.this, CustomerProfile.class);
                        if (intent != null) {
                            intent.putExtra("traderorcustomer", traderID);
                            intent.putExtra("role", role);
                            startActivity(intent);
